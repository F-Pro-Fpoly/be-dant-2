    ...
    public function transform(Booking $booking)
    {
        ...
        if($booking->type == "NOLOGIN"){
              $data =  [
                ...
                'city_code' => $booking->city_code ?? null,
                'type' => $booking->type,
                'phone' => $booking->phone ?? null,
                'email' => $booking->email ?? null,
                'birthday' => $booking->birthday ?? null,
                'district_code' => $booking->district_code ?? null,
                'price' => $booking->price,
                'ward_code' => $booking->ward_code ?? null,
            ...
            $data =  [
                ...
                'city_code' => $booking->user->city_code ?? null,
                'type' => $booking->type,
                'phone' => $booking->user->phone ?? null,
                'email' => $booking->user->email ?? null,
                'birthday' => $booking->user->birthday ?? null,
                'district_code' => $booking->user->district_code ?? null,
                'price' => $booking->price,
                'ward_code' => $booking->user->ward_code ?? null,
                'date' => $booking->schedule->date ?? null,
                'time_start' =>$booking->schedule->timeslot->time_start ?? null,
                'time_end' =>$booking->schedule->timeslot->time_end ?? null,
                'time_apointment' => $times ?? null,
