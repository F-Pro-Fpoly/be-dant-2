...
<body>
    <div class="medical">
        ...
        <div class="medical-right">
            <h2 class="text-color-blue medical-title">Chi tiết lịch khám</h2>
            ...
            @foreach ($bookings as $booking)     
                <div class="medical-content">
                    ...
                    <div class="medical-content-item">
                        ...
                        <span>Thời gian khám: {{$booking->schedule->timeslot->time_start ?? ''}} - {{$booking->schedule->timeslot->time_end ?? ''}}</span><br>
                        <span>Ngày Khám:  {{$booking->schedule->date ?? ''}}</span><br>
